...
const requirements = [
  {
    ...
    documents: [
      { name: "IMM 1294 Form", details: "Application for Study Permit Made Outside of Canada" },
      { name: "Schedule 1 (if applicable)", details: "For certain countries or travel histories" }
    ]
  },
  {
    category: "Acceptance Proof",
    documents: [
      { name: "Letter of Acceptance", details: "From a Designated Learning Institution (DLI)" }
    ]
  },
  {
    category: "Identity Documents",
    documents: [
      { name: "Valid Passport", details: "Must be valid for the duration of the study period" },
      { name: "Passport-size Photos", details: "Recent (as per IRCC photo specifications)" }
    ]
  },
  {
    category: "Financial Proof",
    documents: [
      { name: "Guaranteed Investment Certificate (GIC)", details: "CAD 20,635 under SDS" },
      { name: "Proof of Tuition Fee Payment", details: "Receipt or letter from the college/university" },
      { name: "Bank Statements", details: "Minimum 4 months (for Non-SDS)" },
      { name: "Education Loan Document", details: "Optional but useful proof of funds" }
    ]
  },
  {
    category: "Academic Documents",
    documents: [
      { name: "All Educational Transcripts", details: "10th, 12th, Bachelor's (if applicable)" },
      { name: "IELTS / TOEFL Score", details: "English proficiency proof" }
    ]
  },
  {
    category: "Purpose & Ties",
    documents: [
      { name: "Statement of Purpose (SOP)", details: "Explains reason for study, future plans, and home ties" },
      { name: "Work Experience / Resume", details: "If applicable" }
    ]
  },
  {
    category: "Medical & Background",
    documents: [
      { name: "Medical Examination Report", details: "From an IRCC-approved panel physician" },
      { name: "Police Clearance Certificate", details: "To show no criminal record" }
    ]
  },
  {
    category: "Additional Documents",
    documents: [
      { name: "CAQ (for Quebec Students)", details: "Certificate of Acceptance from Quebec" },
      { name: "Fee Payment Receipt", details: "Visa application fee and biometric fee" },
      { name: "Biometrics", details: "Fingerprints & photo (at VAC center)" }
    ]
  }
];
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-slate-500">
                Complete document checklist for Canadian student visa application
              </p>
            </div>
          </motion.div>
