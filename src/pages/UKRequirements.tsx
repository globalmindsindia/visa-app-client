...
const requirements = [
  {
    ...
    documents: [
      { name: "Online Application", details: "Complete application on gov.uk website" },
      { name: "CAS Number", details: "Confirmation of Acceptance for Studies from university" }
    ]
  },
  {
    category: "Acceptance Documents",
    documents: [
      { name: "CAS Statement", details: "From licensed Tier 4 sponsor (university)" },
      { name: "Unconditional Offer Letter", details: "Final acceptance from the institution" }
    ]
  },
  {
    ...
    documents: [
      ...
      { name: "Biometric Information", details: "Fingerprints and photograph at visa center" }
    ]
  },
  {
    category: "Financial Evidence",
    documents: [
      { name: "Bank Statements", details: "28 days of financial history showing required funds" },
      { name: "Tuition Fee Payment", details: "Evidence of fees paid to the institution" },
      { name: "Maintenance Funds", details: "£1,334/month for London, £1,023/month outside London" },
      { name: "Sponsor Documents", details: "If sponsored by parents or organization" }
    ]
  },
  {
    category: "Academic Qualifications",
    documents: [
      { name: "Academic Transcripts", details: "Official transcripts from previous institutions" },
      { name: "Degree Certificates", details: "All completed qualifications" },
      { name: "English Language Test", details: "IELTS, TOEFL, or accepted alternative" }
    ]
  },
  {
    category: "English Proficiency",
    documents: [
      { name: "IELTS Academic", details: "Minimum 5.5 overall (varies by course)" },
      { name: "TOEFL iBT", details: "Alternative English language proof" },
      { name: "PTE Academic", details: "Pearson Test of English Academic" }
    ]
  },
  {
    category: "Health & Character",
    documents: [
      { name: "TB Test Results", details: "From approved clinic (if from certain countries)" },
      { name: "Criminal Record Check", details: "Police clearance certificate if required" },
      { name: "Immigration Health Surcharge", details: "NHS healthcare payment" }
    ]
  },
  {
    category: "Supporting Documents",
    documents: [
      { name: "ATAS Certificate", details: "If studying sensitive subjects (engineering, sciences)" },
      { name: "Parental Consent", details: "If under 18 years old" }
    ]
  },
  {
    category: "Application Process",
    documents: [
      { name: "Visa Application Fee", details: "Student visa application fee payment" },
      { name: "Priority Service", details: "Optional faster processing service" }
    ]
  }
];
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-slate-500">
                Complete document checklist for UK Student visa application
              </p>
            </div>
          </motion.div>
